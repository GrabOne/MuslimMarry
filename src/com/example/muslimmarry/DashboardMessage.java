...
public class DashboardMessage extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.dashboard_message, container, false);
		...
		mList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				// TODO Auto-generated method stub
				MessagingPage fr = new MessagingPage();
		...
		adapter = new DashBoardMessageAdapter(getActivity(), R.layout.dashboard_message_row, mlst);
