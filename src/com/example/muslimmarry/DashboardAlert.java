...
public class DashboardAlert extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.dashboard_alert, container, false);
		...
		mList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				// TODO Auto-generated method stub
				GiftReceivePage fr = new GiftReceivePage();
		...
		adapter = new DashboardAlertAdapter(getActivity(), R.layout.dashboard_alert_row, mlst);
