...
public class LocateActivity extends Activity implements GoogleApiClient.ConnectionCallbacks,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// create user object
		user = new prefUser(LocateActivity.this);
	...
	private class Signup extends AsyncTask<String, String, Void>{
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			pd = new TransparentProgressDialog(LocateActivity.this, R.drawable.loading_spinner);
			pd.show();
		}
		@Override
		...
		protected void onPostExecute(Void result) {
			...
			try{
				...
				if(jObj.getString("status").equalsIgnoreCase("success")){
					...
					Intent i = new Intent(LocateActivity.this, MainActivity.class);
					startActivity(i);
