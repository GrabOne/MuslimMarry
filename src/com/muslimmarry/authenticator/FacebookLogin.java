			...
			try{
				...
				if(jObj.getString("status").equalsIgnoreCase("success")){
					...
					user.createUserSession(data.getString("_id"), new String(data.getString("nickname").getBytes("UTF-8"), "UTF-8"), "", new String(data.getString("email").getBytes("UTF-8"), "UTF-8"), data.getString("age"),
							...
							locate.getString("country"), _city, coordinates.getString("lat"), coordinates.getString("lng"), data.getString("promocode"), "fb", data.getString("facebook_id"), "true", String.valueOf(mes), String.valueOf(gift));
